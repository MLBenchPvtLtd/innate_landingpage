...
function WorkSlider3() {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center relative">
      {/* Text Content */}
      <div className="absolute inset-0 flex justify-center items-center z-10 text-center bg-opacity-50">
        {imageLoaded && (
          <div>
            <Text
              as="h1"
      ...
      <div className="relative w-full h-full flex justify-center items-center">
        <Image
          className="cards-custom-prev14 absolute left-4 top-1/2 transform -translate-y-1/2"
          onClick={handleprevbtn}
          src={leftarrow}
          alt="moveprevbtn"
        />
        <Image
          className="cards-custom-next14 absolute right-4 top-1/2 transform -translate-y-1/2"
