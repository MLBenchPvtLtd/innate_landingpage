...
function WorkSlider3() {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden">
      {/* Text Content */}
      <div className="absolute inset-0 flex flex-col justify-center items-center z-10 bg-opacity-50 bg-black">
        {imageLoaded && (
      ...
      <div className="w-full flex justify-center items-center relative">
        {/* Navigation Arrows */}
        <Image
          className="cards-custom-prev12 absolute left-4 top-1/2 transform -translate-y-1/2 cursor-pointer"
